  ...
  return (
    <div className="mb-2">
      ...
      {/* <button
        ...
        onClick={onToggle}
      >
        <span className="flex items-center">Hospitalization</span>
      ...
      {isOpen && ( */}
        <div className="mt-1 p-2 border-2 bg-gray-100 bg-white rounded-md">
          <div className="grid grid-cols-2 gap-4">
            ...
            <input type="date" name="dateOfAdmission" value={formData.hospitalization.dateOfAdmission} onChange={handleChange} className="border rounded px-2 py-1" />
            <label>Date of Discharge:</label>
            <input type="date" name="dateOfDischarge" value={formData.hospitalization.dateOfDischarge} onChange={handleChange} className="border rounded px-2 py-1" />
...
<div className="flex items-center border rounded px-2 py-1">
  ...
  />
            ...
            {formData.hospitalization.isICU && (
              <>
                <div className="col-span-2 ml-10">
                  ...
                  <input type="date" name="icuAdmissionDate" value={formData.hospitalization.icuAdmissionDate} onChange={handleChange} className="border rounded px-2 py-1 ml-20" />
                </div>
                <div className="col-span-2 ml-10">
                  <label>Date Discharge from ICU:</label>
                  <input type="date" name="icuDischargeDate" value={formData.hospitalization.icuDischargeDate} onChange={handleChange} className="border rounded px-2 py-1 ml-16 mb-4" />
                </div>
              </>
            )}
            ...
            <div className="flex items-center mb-2">
              <input type="file" name="diagnosisCard" onChange={handleChange} className="border rounded px-2 py-1 w-48" />
              {filePreviews[0] && (
            ...
            <div className="flex items-center mb-2">
              <input type="file" name="hospitalBill" onChange={handleChange} className="border rounded px-2 py-1 w-48" />
              {filePreviews[1] && (
                <div className="flex items-center ml-2">
            ...
            <div className="flex items-center mb-2">
              <input type="file" name="paymentReceipt" onChange={handleChange} className="border rounded px-2 py-1 w-48" />
              {filePreviews[2] && (
                <div className="flex items-center ml-2">
            ...
            <div className="flex items-center mb-2">
              <input type="file" name="medicalReports" onChange={handleChange} className="border rounded px-2 py-1 w-48" />
              {filePreviews[3] && (
                <div className="flex items-center ml-2">
